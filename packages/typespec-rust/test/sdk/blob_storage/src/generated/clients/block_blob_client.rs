...
use crate::generated::models::{
    ...
    BlockBlobClientUploadBlobFromUrlResult, BlockBlobClientUploadInternalOptions,
    BlockBlobClientUploadInternalResult, BlockList, BlockListType, BlockLookupList,
};
use azure_core::{
    base64,
