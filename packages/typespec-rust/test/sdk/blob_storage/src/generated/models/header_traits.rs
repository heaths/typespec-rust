...
/// use blob_storage::models::{BlobClientDownloadInternalResult, BlobClientDownloadInternalResultHeaders};
/// async fn example() -> Result<()> {
...
/// ```no_run
/// use azure_core::{Result, http::{Response, NoFormat}};
/// use blob_storage::models::{BlockBlobClientUploadBlobFromUrlResult, BlockBlobClientUploadBlobFromUrlResultHeaders};
/// async fn example() -> Result<()> {
...
/// ```no_run
/// use azure_core::{Result, http::{Response, XmlFormat}};
/// use blob_storage::models::{SignedIdentifiers, SignedIdentifiersHeaders};
/// async fn example() -> Result<()> {
